...
class ControllerSetup extends Controller
{
    ...
    public function export(){
        ...
        $dbuser = Configuration::get("dbuser");
        $dbpassword = Configuration::get("dbpassword");
        //pas très propre mais le substr enleve le mot "/controller"
        $file = substr(dirname(__FILE__), 0, -11) . DIRECTORY_SEPARATOR . "database" . DIRECTORY_SEPARATOR . "{$dbname}_dump.sql"; 
