function setup_calendar() {
    ...
    // effectue la requête pour récupérer les données de calendrier, configure l'ensemble et lance le rendu.
    function build() {
        $.post({
    ...
    function build_boards_selectors() {
