...
function setup_collab_delete_confirm() {
    let click_handler_config = {
        ...
        form_selector: "#remove-collab-form",
        id_node_selector : "#remove-collab-form input[name=board_id]"
    }
    $("#collab-delete").click(get_delete_click_handler(click_handler_config));
}
